    ...
    def _apply_80_percent_throttling(self, stage_name: str):
        ...
        if self.resource_controller_80:
            ...
            if throttle_needed:
                ...
                # แสดงสถานะทรัพยากร
                usage = self.resource_controller_80.get_current_usage()
                self.safe_logger.info(f"📊 {stage_name} Resources: CPU {usage.get('cpu_percent', 0)}%, Memory {usage.get('memory_percent', 0)}%")
